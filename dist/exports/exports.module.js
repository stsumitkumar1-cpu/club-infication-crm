...
const exports_controller_js_1 = require("./exports.controller.js");
...
exports.ExportsModule = ExportsModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [exports_controller_js_1.ExportsController],
        providers: [exports_service_js_1.ExportsService],
        exports: [exports_service_js_1.ExportsService],
    })
], ExportsModule);
